...
DepartmentID INT, Salary DECIMAL(10, 2), HireDate DATE, ManagerID INT, FOREIGN KEY (ManagerID) REFERENCES Employees(EmployeeID) );
...
INSERT INTO Enrollments (StudentID, CourseID) VALUES (1, 1), (2, 1), (7, 1), (11, 1), (20, 1), (25, 1), (33, 1), (3, 2), (9, 2), (14, 2), (22, 2), (28, 2), (35, 2), (5, 3), (13, 3), (21, 3),
(27, 3), (34, 3), (10, 4), (16, 4), (24, 4), (30, 4), (37, 4), (6, 5), (15, 5), (23, 5), (29, 5), (36, 5);
...
select E.Name as EmployeeName,E2.Name as ManagerName from Employees as E
inner join Employees as E2
on E.EmployeeID=E2.ManagerID

select * from Employees;

--Using the Students, Courses, and Enrollments tables, write a query 
--to list the names of students who are enrolled in the course named 'Math 101'.
...
select  C.FirstName, C.LastName,sum(O.Quantity) as TotalOrders from Customers as C
inner join Orders as O
on C.CustomerID=O.CustomerID
...
select * from Employees
select E1.Name,E2.Name,E1.ManagerID from Employees as E1
inner join Employees as E2
on E1.EmployeeID<>E2.EmployeeID and E1.ManagerID=E2.ManagerID
...
select O.OrderID,year(OrderDate) as year from Orders as O
...
select E1.Name,E2.Name,E1.ManagerID,E1.Salary from Employees as E1
inner join Employees as E2
on E1.ManagerID=E2.ManagerID and E1.DepartmentID<>E2.DepartmentID
