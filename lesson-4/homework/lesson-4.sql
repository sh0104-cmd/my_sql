...
create database homeworkEmployees;
use homeworkEmployees;
...
as Email
from Employees; --SELECT ISNULL(Email, 'No Email') AS Email FROM YourTable
...
--SELECT AVG(Price): This part calculates the average of the values in the Price column.
--AS AveragePrice: This gives a name (alias) to the result column, so the output will have a header labeled "AveragePrice".
--FROM Products: This specifies that the data is being selected from the Products table
 ...
 CustomerID INT, ProductID INT, OrderDate DATE, Quantity INT, TotalAmount DECIMAL(10, 2), 
 ...
 INSERT INTO Orders VALUES (1, 1, 2, '2023-05-14', 1, 800.00), (2, 2, 3, '2024-09-07', 2, 800.00), (3, 3, 4, '2022-11-22', 1, 250.00), (4, 4, 5, '2021-03-30', 3, 150.00), (5, 5, 6, '2025-07-19', 1, 30.00), 
 ...
 (36, 36, 37, '2023-12-22', 1, 35.00), (37, 37, 38, '2021-06-06', 2, 110.00), (38, 38, 39, '2025-02-01', 1, 40.00), (39, 39, 40, '2023-11-26', 3, 120.00), 
