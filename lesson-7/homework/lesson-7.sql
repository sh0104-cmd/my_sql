...
CREATE TABLE Sales ( SaleID INT PRIMARY KEY, ProductID INT, CustomerID INT, SaleDate DATE, SaleAmount DECIMAL(10, 2),Category VARCHAR(50) );

INSERT INTO Sales (SaleID, ProductID, CustomerID, SaleDate, SaleAmount,Category ) VALUES (1, 1, 1, '2023-01-01', 150.00,'Electronics'), 
(2, 2, 2, '2023-01-02', 200.00,'Electronics'), (3, 3, 3, '2023-01-03', 250.00,'Electronics'), 
(4, 4, 4, '2023-01-04', 300.00,'Electronics'), (5, 5, 5, '2023-01-05', 350.00, 'Accessories'), (6, 6, 6, '2023-01-06', 400.00,'Accessories'), 
(7, 7, 7, '2023-01-07', 450.00, 'Furniture'), (8, 8, 8, '2023-01-08', 500.00, 'Furniture'), (9, 9, 9, '2023-01-09', 550.00, 'Stationery'), 
(10, 10, 10, '2023-01-10', 600.00, 'Stationery'), (11, 1, 1, '2023-01-11', 150.00,'Electronics'), (12, 2, 2, '2023-01-12', 200.00,'Electronics'), 
(13, 3, 3, '2023-01-13', 250.00, 'Tools'), (14, 4, 4, '2023-01-14', 300.00,'Clothing'), (15, 5, 5, '2023-01-15', 350.00,'Clothing'), 
(16, 6, 6, '2023-01-16', 400.00,'Clothing'), (17, 7, 7, '2023-01-17', 450.00,'Clothing'), (18, 8, 8, '2023-01-18', 500.00, 'Accessories'), 
(19, 9, 9, '2023-01-19', 550.00,'Clothing'), (20, 10, 10, '2023-01-20', 600.00,'Clothing'), (21, 1, 2, '2023-01-21', 150.00,'Furniture'), 
(22, 2, 3, '2023-01-22', 200.00,'Furniture'), (23, 3, 4, '2023-01-23', 250.00,'Stationery'), (24, 4, 5, '2023-01-24', 300.00,'Furniture'), 
(25, 5, 6, '2023-01-25', 350.00,'Accessories'), (26, 6, 7, '2023-01-26', 400.00,'Accessories'), (27, 7, 8, '2023-01-27', 450.00,'Furniture'), 
(28, 8, 9, '2023-01-28', 500.00,'Electronics'), (29, 9, 10, '2023-01-29', 550.00,'Electronics'), (30, 10, 1, '2023-01-30', 600.00,'Electronics'), 
(31, 1, 2, '2023-02-01', 150.00,'Electronics'), (32, 2, 3, '2023-02-02', 200.00,'Electronics'), (33, 3, 4, '2023-02-03', 250.00,'Electronics'), 
(34, 4, 5, '2023-02-04', 300.00,'Accessories'), (35, 5, 6, '2023-02-05', 350.00,'Electronics'), (36, 6, 7, '2023-02-06', 400.00,'Electronics'), 
(37, 7, 8, '2023-02-07', 450.00,'Electronics'), (38, 8, 9, '2023-02-08', 500.00,'Electronics'), (39, 9, 10, '2023-02-09', 550.00,'Electronics'), 
(40, 10, 1, '2023-02-10', 600.00,'Electronics');
...
select sum(SaleAmount) as sale_amount,CustomerID from Sales
group by CustomerID;

--Write a query to use HAVING to filter
--departments having more than 5 employees from the Employees table.(DeptID is enough, if you don't have DeptName).

select * from Employees;
select DepartmentName,count(EmployeeID) as employees from Employees
group by DepartmentName
...
select * from Sales;
select Category,sum(SaleAmount),avg(SaleAmount) from Sales
group by Category;
...
--Write a query that finds the highest (MAX) and lowest (MIN) Salary by department in the Employees table.
...
--Write a query that applies the HAVING clause to filter out Departments with total salary expenses greater than 500,000.
--(DeptID is enough, if you don't have DeptName).
...
--Hard-Level Tasks (6)
--Write a query that shows the average (AVG) sales for each product category, and 
--then uses HAVING to filter categories with an average sales amount greater than 200.
select * from Sales;
select Category,avg(SaleAmount) from Sales
group by Category
having avg(SaleAmount)>200;

--Write a query to calculate the total (SUM) sales for each Customer, 
...
--Write a query to find the total (SUM) and average (AVG) salary of employees grouped by department, 
--and use HAVING to include only departments with an average salary greater than 65000.

select DepartmentName,sum(Salary) as sum_salary,avg(Salary) avg_salary from Employees
group by DepartmentName
having avg(Salary)>65000;

--Write a query that finds the maximum (MAX) and minimum (MIN) order value for each customer, and
--then applies HAVING to exclude customers with an order value less than 50.

select * from Orders
select CustomerID,max(TotalAmount),min(TotalAmount) from Orders
group by CustomerID
having min(TotalAmount)>50;

--Write a query that calculates the total sales (SUM) and counts distinct products sold in each month, 
--and then applies HAVING to filter the months with more than 8 products sold.

select * from Sales

select sum(SaleAmount) as total_sales,count(distinct ProductID) as products,month(SaleDate) as sale_month from Sales
